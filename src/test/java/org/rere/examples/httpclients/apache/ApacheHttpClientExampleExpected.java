...
HTTP/1.1 200 OK
200 OK
<!doctype html><html itemscope="" itemtype="http://schema.org/WebPage" lang="en"><head><meta content="Search the world's information, including webpages, images, videos and more. Google has many special features to help you find exactly what you're looking for." name="description"><meta content="noodp, " name="robots"><meta content="text/html; charset=UTF-8" http-equiv="Content-Type"><meta content="/images/branding/googleg/1x/googleg_standard_color_128dp.png" itemprop="image"><title>Google</title><script nonce="w36z1fc2c1CrvEcSnYawIg">(function(){var _g={kEI:'6SSwZ-K8Cfic0PEP0o7psA8',kEXPI:'0,202746,3497503,1135,538661,2872,2891,43028,46127,78219,266577,94242,5824,54903,57082,26407,8861,11814,30911,5241521,126,8834925,81,12,25,7437695,20539939,25228681,123103,885,14280,8182,5933,4559,38937,19011,2664,3430,3319,23878,9139,745,1,3,3851,328,6225,1116,33195,29854,1341,11793,1915,8210,3286,4134,12595,8711,33,9041,17667,10666,21345,2990,1497,3413,440,41,6135,7504,1,4362,513,1866,4105,22351,3,2749,950,2147,4610,7,5773,4310,2327,1308,2,738,4379,420,1547,181,2,9516,665,2217,835,2,911,2,1920,1049,837,1708,4899,2326,2035,2801,460,43,416,2531,28,7,1,1293,161,75,564,172,6,1148,713,250,1519,381,1,893,56,1026,2,211,616,221,1,2633,224,87,831,83,448,5,921,681,1338,343,569,1237,47,507,727,272,2,778,1916,846,1119,2,627,709,227,1964,2,202,354,656,388,139,3,2820,5,5,394,828,439,6,91,8,441,385,6,2,1359,1252,849,342,12,1,1,360,735,303,3,2,1,2,2,2,3,988,111,344,405,3,42,1,7,68,1,436,100,213,602,1040,409,143,337,9,2,896,241,1587,65,5,223,606,1022,210,22,231,293,438,2,1,6,38,1929,92,307,238,353,856,1,4,22,1256,136,937,50,335,27,207,155,437,305,21,8,58,403,85,143,267,1,12,559,55,1355,64,538,399,171,182,186,45,16,13,8,2,30,141,158,333,259,165,2,6,45,41,562,20,3,345,16,111,165,316,11,728,259,403,14,176,186,640,3,210,1312,1,2,2,3,1430,8,248,12,1604,21353369,18,2010,7,41,523,1153,806,8,766,3107,12,6236,8017876',kBL:'ntjc',kOPI:89978449};(function(){var a;((a=window.google)==null?0:a.stvsc)?google.kEI=_g.kEI:window.google=_g;}).call(this);})();(function(){google.sn='webhp';google.kHL='en';})();(function(){
...
public class ApacheHttpClientExampleExpected {
  ...
  public static BasicStatusLine environmentNode2() throws Exception {
    ...
    doReturn("HTTP/1.1 200 OK").when(mockObject).toString();
    return mockObject;
  }
  ...
  public static BasicStatusLine environmentNode4() throws Exception {
    BasicStatusLine mockObject = mock(BasicStatusLine.class);
    doReturn(200).when(mockObject).getStatusCode();
    doReturn("OK").when(mockObject).getReasonPhrase();
    return mockObject;
  }

  public static InputStream environmentNode6() throws Exception {
    InputStream mockObject = mock(InputStream.class);
    doReturn(428).doReturn(774).doReturn(975).doReturn(1108).doReturn(1219).doReturn(1180).doReturn(1097).doReturn(1227).doReturn(1410).doReturn(1478).doReturn(1338).doReturn(1537).doReturn(1383).doReturn(1344).doReturn(1180).doReturn(1117).doReturn(-1).when(mockObject).read(any(), anyInt(), anyInt());
    doReturn(1).doReturn(1).doReturn(1).doReturn(1).doReturn(1).doReturn(1).doReturn(1).doReturn(1).doReturn(1).doReturn(1).doReturn(1).doReturn(1).doReturn(1).doReturn(1).doReturn(1).doReturn(0).when(mockObject).available();
  ...
  public static BasicNameValuePair environmentNode11() throws Exception {
    ...
    doReturn("ISO-8859-1").when(mockObject).getValue();
    doReturn("charset").when(mockObject).getName();
    return mockObject;
  }
  ...
  public static BasicHeaderElement environmentNode9() throws Exception {
    ...
    doReturn("text/html").when(mockObject).getName();
  ...
  public static DecompressingEntity environmentNode5() throws Exception {
    ...
    doReturn(-1).doReturn(-1).when(mockObject).getContentLength();
    return mockObject;
  }
